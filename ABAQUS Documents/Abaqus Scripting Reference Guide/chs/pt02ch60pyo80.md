...
- 对数体积模量，![](../graphics/ker_eqn00342.gif)![](../graphics/ker_eqn00182.gif)![](../graphics/ker_eqn00343.gif)![](../graphics/ker_eqn00342.gif)![](../graphics/ker_eqn00164.gif)![](../graphics/ker_eqn00343.gif)。（此值不能为负。）
- 温度（如果数据依赖温度）。
- 第一个场变量的值（如果数据依赖场变量）。
- 第二个场变量的值。
- 依此类推。
