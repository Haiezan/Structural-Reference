...
![](../graphics/stm_eqn06001.gif)作为初始猜测，如果我们使用![](../graphics/stm_eqn06002.gif)，如果![](../graphics/stm_eqn06003.gif)则使用![](../graphics/stm_eqn06004.gif)（符号选择与![](../graphics/stm_eqn00377.gif)相同）。

![](../graphics/stm_eqn06005.gif)在这种情况下材料刚度矩阵为
