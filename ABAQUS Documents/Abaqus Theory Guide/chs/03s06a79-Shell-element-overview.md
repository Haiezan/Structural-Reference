...
In geometrically nonlinear analyses in Abaqus/Standard the cross-section thickness of finite-strain shell elements changes as a function of the membrane strain based on a user-defined "effective section Poisson's ratio," . In Abaqus/Explicit the thickness change is based on the "effective section Poisson's ratio" for all shell elements in large-deformation analyses, unless the user has specified that the thickness change should be based on the element material definition. The thickness change based on the "effective section Poisson's ratio" is calculated as follows.
