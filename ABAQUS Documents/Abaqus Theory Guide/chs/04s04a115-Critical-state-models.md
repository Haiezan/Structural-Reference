...
![](../graphics/stm_eqn06200.gif)![](../graphics/stm_eqn01111.gif)![](../graphics/stm_eqn06201.gif)![](../graphics/stm_eqn06202.gif)![](../graphics/stm_eqn06203.gif)![](../graphics/stm_eqn06151.gif)![](../graphics/stm_eqn06204.gif)![](../graphics/stm_eqn06205.gif)![](../graphics/stm_eqn06097.gif)在此方程中，面上形成屈服面，定义为
...
![](../graphics/stm_eqn06209.gif)其中![](../graphics/stm_eqn00280.gif)常数。积分这个方程，并利用[公式4.4.3-1](04s04a115.md)、[公式4.4.1-2](04s04a113.md)和[公式4.4.1-4](04s04a113.md)，我们得到
...
![](../graphics/stm_eqn01917.gif)![](../graphics/stm_eqn06213.gif)屈服面的演化也可以定义为分 piecewise linear function relating the yield stress in hydrostatic compression, ![](../graphics/stm_eqn06214.gif) Then the evolution parameter, *a*, is given by

![](../graphics/stm_eqn06215.gif)Note that the volumetric plastic strain axis has an arbitrary origin: ![](../graphics/stm_eqn06216.gif)体积塑性应变轴上对应于材料初始状态的位置上的值，从而定义了初始静水压力，![](../graphics/stm_eqn06217.gif)因此初始屈服面大小，![](../graphics/stm_eqn06211.gif)

图4.4.3-7 分段线性硬化/软化曲线。

![](../graphics/cclayplas-hard-soft.png)

![](../graphics/stm_eqn06211.gif)Abaqus检查初始有效应力状态是否在初始屈服面内部或之上。在任何违反屈服函数的材料点上，"Critical state (clay) plasticity model,"  Section 23.3.4 of the Abaqus Analysis User's Guide
### 参考
### 参考
