...
![](../graphics/stm_eqn06219.gif)![](../graphics/stm_eqn06220.gif)偏应力第三不变量

![](../graphics/stm_eqn05837.gif)![](../graphics/stm_eqn00522.gif)应力偏量，定义为

![](../graphics/stm_eqn06221.gif)![](../graphics/stm_eqn06222.gif)中![](../graphics/stm_eqn06223.gif)材料参数，可能依赖于温度，![](../graphics/stm_eqn01111.gif)和其他预定义场![](../graphics/stm_eqn06224.gif)使用这种偏应力测度是因为它允许在偏量平面上匹配拉伸和压缩中不同的应力值，从而提供拟合实验结果的灵活性，并对Mohr-Coulomb面进行平滑近似。由于在单轴拉伸时![](../graphics/stm_eqn06225.gif)在这种情况下![](../graphics/stm_eqn06123.gif)由于在单轴压缩时![](../graphics/stm_eqn06226.gif)在那种情况下![](../graphics/stm_eqn06125.gif)当![](../graphics/stm_eqn06208.gif)，对第三偏应力不变量的依赖被消除；在偏量平面上恢复Mises圆：![](../graphics/stm_eqn06125.gif)[图4.4.4-2](04s04a116.md)显示了*t*对*K*的依赖性。为确保屈服面的凸性，![](../graphics/stm_eqn06121.gif)
...
![](../graphics/stm_eqn06227.gif)![](../graphics/stm_eqn06165.gif)![](../graphics/stm_eqn06228.gif)![](../graphics/stm_eqn06229.gif)中![](../graphics/stm_eqn06230.gif)控制帽形状的材料参数，![](../graphics/stm_eqn06231.gif)一个小数字，在下面定义，![](../graphics/stm_eqn06232.gif)演化参数，表示体积塑性应变驱动的硬化/软化。硬化/软化律是用户定义的分段线性函数，关系静水压缩屈服应力，![](../graphics/stm_eqn06233.gif)与相应的体积非弹性（塑性和/或蠕变）应变，![](../graphics/stm_eqn06234.gif)[图4.4.4-3](04s04a116.md)），其中![](../graphics/stm_eqn06235.gif)

图4.4.4-3 典型的帽硬化。

![](../graphics/ccapplas-hard.png)

![](../graphics/stm_eqn06232.gif)演化参数，![](../graphics/stm_eqn06236.gif)

![](../graphics/stm_eqn00904.gif)参数![](../graphics/stm_eqn06237.gif)
### 流动规则
...
![](../graphics/stm_eqn06238.gif)破坏和过渡区域中提供非相关流动分量的另一个椭圆部分：

![](../graphics/stm_eqn06239.gif)![](../graphics/stm_eqn05852.gif)![](../graphics/stm_eqn06240.gif)形成一个连续且平滑的势面。
...
如上所述，帽面随着体积塑性应变和体积蠕变应变硬化或软化：体积非弹性压实（当在帽上屈服或通过固结机制蠕变时）导致硬化，而体积塑性膨胀（当在剪切破坏面上屈服或通过内聚机制蠕变时）导致软化。两个屈服面之间的分离和两个蠕变机制的主要区域由演化参数定义，![](../graphics/stm_eqn06232.gif)它与用户定义的静水压缩屈服应力，![](../graphics/ccapplas-active-creep-nls.png)
...
接下来考虑固结蠕变机制。在这种情况下，我们希望使蠕变依赖于高于阈值
...
![](../graphics/stm_eqn06250.gif)![](../graphics/stm_eqn06169.gif)蠕变流动规则从蠕变势![](../graphics/stm_eqn06251.gif)![](../graphics/stm_eqn06118.gif)![](../graphics/stm_eqn00596.gif)![](../graphics/stm_eqn06172.gif)![](../graphics/stm_eqn06252.gif)义的比例因子，其中
...
![](../graphics/ccapplas-consolid-creep-nls.png)![](../graphics/stm_eqn06264.gif)图4.4.4-8 蠕变势：固结机制。

![](../graphics/stm_eqn06265.gif)![](../graphics/stm_eqn06266.gif)意，存在一个等效压力应力，![](../graphics/stm_eqn06267.gif)它是等效固结蠕变应变的功共轭，与有效蠕变压力![](../graphics/stm_eqn06268.gif)同。这样的等效压力应力由
