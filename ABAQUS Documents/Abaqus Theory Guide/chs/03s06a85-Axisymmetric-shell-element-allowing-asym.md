...
![](../graphics/stm_eqn04648.gif)对于旋转分量，对称要求将*r*和*z*分量与![](../graphics/stm_eqn01111.gif)分量的角色交换：
...
![](../graphics/stm_eqn04657.gif)类似地，用分别替换![](../graphics/stm_eqn04658.gif)和![](../graphics/stm_eqn04659.gif)，旋转分量的插值变为

![](../graphics/stm_eqn04660.gif)![](../graphics/stm_eqn04661.gif)![](../graphics/stm_eqn04662.gif)在上述插值中，![](../graphics/stm_eqn04651.gif)、![](../graphics/stm_eqn04652.gif)和![](../graphics/stm_eqn04653.gif)是![](../graphics/stm_eqn04663.gif)处的物理位移和旋转分量，![](../graphics/stm_eqn04664.gif)和是三角插值函数，其性质为![](../graphics/stm_eqn04665.gif)，定义为：
...
![](../graphics/stm_eqn04689.gif)给出。请注意，在虚功的声明中，尚未对曲线坐标函数做出选择。此外，当前体积度量![](../graphics/stm_eqn04690.gif)![](../graphics/stm_eqn04691.gif)![](../graphics/stm_eqn00798.gif)由参数关系给出
...
![](../graphics/stm_eqn04783.gif)这里我们使用符号![](../graphics/stm_eqn04784.gif)来表示由四元数旋转向量![](../graphics/stm_eqn00427.gif)。曲率由方向场的梯度计算，方向场通过

![](../graphics/stm_eqn04785.gif)![](../graphics/stm_eqn04786.gif)更新，其中
...
有必要在单元表面上的选定节点处强制执行旋转约束，以防止变形的奇异模式。在每个节点平面内每对节点之间强制执行一个轴向横向剪切约束。在周向节点线的每对节点之间强制执行一个周向横向剪切约束和一个关于旋转场![](../graphics/stm_eqn04650.gif)![](../graphics/stm_eqn02779.gif)和![](../graphics/stm_eqn04826.gif)的钻孔旋转约束。在每种情况下，旋转场被约束为跟随节点位移。总而言之，对于单元SAXAMN：
...
![](../graphics/stm_eqn04860.gif)这里上标*m*和*n*指的是*r*-*z*平面中的特定节点，上标*p*和*q*指的是沿周向的特定位置。插值函数![](../graphics/stm_eqn04861.gif)、![](../graphics/stm_eqn03255.gif)和![](../graphics/stm_eqn03256.gif)是*r*-*z*平面中的插值函数与![](../graphics/stm_eqn04862.gif)![](../graphics/stm_eqn01111.gif)方向中插值函数的乘积：
