...
选择这个面在处与![](../graphics/stm_eqn05441.gif)连续混合，并在![](../graphics/stm_eqn05442.gif)![](../graphics/stm_eqn05443.gif)处作为行为的合理估计。否则，它是任意的。[Rice（1972）](07s01a01-References.md)指出在![](../graphics/stm_eqn05444.gif)处，屈服面将有一个顶点。Abaqus中使用的光滑面是为数值原因采用的。这种光滑性限制了![](../graphics/stm_eqn05445.gif)处可能的流动行为，但我们假定这不是关键问题。
