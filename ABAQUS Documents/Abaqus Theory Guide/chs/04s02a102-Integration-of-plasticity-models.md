...
在这些方程中，在本节其余部分，任何未特别与时间点关联的量都取在增量结束时（时间![](../graphics/stm_eqn00438.gif)应变率分解，[公式4.2.1-2](04s02a101.md)，在时间增量上积分给出
...
![](../graphics/stm_eqn05568.gif)![](../graphics/stm_eqn00851.gif)对于具有单个屈服系统的其他率无关模型，代数问题被认为是在硬化律定义硬化变量的增量。
...
![](../graphics/stm_eqn05572.gif)切线弹性矩阵。

硬化律也被精确满足（因为硬化参数的增量由这些律定义），因此

![](../graphics/stm_eqn05573.gif)![](../graphics/stm_eqn01344.gif)![](../graphics/stm_eqn05574.gif)![](../graphics/stm_eqn05575.gif)![](../graphics/stm_eqn00851.gif)![](../graphics/stm_eqn05576.gif)中

![](../graphics/stm_eqn05577.gif)![](../graphics/stm_eqn05578.gif)

流动规则在找到解之前不会被精确满足，因此给出Newton方程

![](../graphics/stm_eqn05579.gif)![](../graphics/stm_eqn05580.gif)中

![](../graphics/stm_eqn05581.gif)![](../graphics/stm_eqn05582.gif)
...
![](../graphics/stm_eqn05584.gif)![](../graphics/stm_eqn05585.gif)

![](../graphics/stm_eqn05575.gif)![](../graphics/stm_eqn05586.gif)我们现在在[公式4.2.2-7](04s02a102.md)和[公式4.2.2-8](04s02a102.md)之间消去![](../graphics/stm_eqn05587.gif)中

![](../graphics/stm_eqn05588.gif)![](../graphics/stm_eqn05589.gif)中

![](../graphics/stm_eqn05590.gif)![](../graphics/stm_eqn05571.gif)具有单个屈服函数的率相关塑性模型的求解以相同的方式开发，唯一的区别是没有屈服约束以及![](../graphics/stm_eqn00851.gif)时间的对应。
### 切线矩阵

![](../graphics/stm_eqn05591.gif)![](../graphics/stm_eqn00033.gif)![](../graphics/stm_eqn00399.gif)当Abaqus/Standard用于隐式时间积分并且使用Newton方法求解平衡方程时，需要材料的切线矩阵，![](../graphics/stm_eqn05592.gif)中

![](../graphics/stm_eqn05593.gif)"Inelastic behavior," Section 23.1.1 of the Abaqus Analysis User's Guide
### 参考
### 参考
