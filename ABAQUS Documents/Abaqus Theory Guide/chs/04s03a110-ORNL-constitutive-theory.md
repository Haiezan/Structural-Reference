...
如果当前原点是![](../graphics/stm_eqn05938.gif)，则当时，有效蠕变应变![](../graphics/stm_eqn05949.gif)递减。类似地，如果当前原点是![](../graphics/stm_eqn05950.gif)![](../graphics/stm_eqn05939.gif)，则当时，有效蠕变应变![](../graphics/stm_eqn05951.gif)递减。基于有效蠕变应变递减（加载反向）的概念，选择新原点的规则在步骤4到14中给出。

如果![](../graphics/stm_eqn05952.gif)![](../graphics/stm_eqn05953.gif)且![](../graphics/stm_eqn05954.gif)，设![](../graphics/stm_eqn05955.gif)并转到步骤13。否则，设![](../graphics/stm_eqn05956.gif)并继续到步骤5。
