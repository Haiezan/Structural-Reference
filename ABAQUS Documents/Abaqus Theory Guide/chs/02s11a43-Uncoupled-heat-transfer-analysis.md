...
假设热问题和力学问题是解耦的，即仅取决于温度，![](../graphics/stm_eqn02231.gif)其中![](../graphics/stm_eqn01111.gif)材料温度，*q*和*r*不依赖于物体的应变或位移。为简单起见，假设使用拉格朗日描述，因此"体积"和"表面积"是指参考配置中的体积和表面积。
### 本构定义
...
![](../graphics/stm_eqn02233.gif)其中![](../graphics/stm_eqn02234.gif)电导率矩阵，![](../graphics/stm_eqn02235.gif)![](../graphics/stm_eqn00480.gif)热通量；![](../graphics/stm_eqn00117.gif)位置。电导率![](../graphics/stm_eqn02234.gif)![](../graphics/stm_eqn02236.gif)![](../graphics/stm_eqn02237.gif)![](../graphics/stm_eqn02238.gif)![](../graphics/stm_eqn02239.gif)![](../graphics/stm_eqn02240.gif)![](../graphics/stm_eqn02241.gif)![](../graphics/stm_eqn02242.gif)![](../graphics/stm_eqn02243.gif)边界条件可以指定为规定温度、能量平衡的变分陈述，[方程2.11.1-1](02s11a43-Uncoupled-heat-transfer-analysis.md)，以及傅里叶定律，[方程2.11.1-2](02s11a43-Uncoupled-heat-transfer-analysis.md)，通过标准Galerkin方法直接获得为
...
![](../graphics/stm_eqn02248.gif)一维、二维和三维中的一阶和二阶多项式用于![](../graphics/stm_eqn02249.gif)通过这些插值，变分陈述，[方程2.11.1-3](02s11a43-Uncoupled-heat-transfer-analysis.md)，变为
...
![](../graphics/stm_eqn02260.gif)这个非线性系统通过改进的Newton法求解。该方法是改进的Newton，因为切线矩阵（Jacobian矩阵）——即[方程2.11.1-6](02s11a43-Uncoupled-heat-transfer-analysis.md)左边相对于![](../graphics/stm_eqn02261.gif)变分率——不是精确形成的。这个切线矩阵中项的形成现在描述。

内能项给出Jacobian贡献：

![](../graphics/stm_eqn02262.gif)![](../graphics/stm_eqn02263.gif)比热，![](../graphics/stm_eqn02264.gif)在潜热范围外；如果在积分点则是![](../graphics/stm_eqn02265.gif)其中![](../graphics/stm_eqn02266.gif)![](../graphics/stm_eqn02267.gif)![](../graphics/stm_eqn02268.gif)液相线和固相线温度，*L*是与此相变相关的潜热。

在严重的潜热情况下，这一项可能导致数值不稳定，因为刚度项![](../graphics/stm_eqn02269.gif)固相线-液相线温度范围之外很小，而在那个相当窄的范围内非常刚硬。为了在这些情况下避免这种不稳定，在求解时间步的早期迭代中，这个项被修改为割线项。由于修改仅发生在涉及潜热的情况下，因此它仅影响那些问题。
...
![](../graphics/stm_eqn00883.gif)Abaqus/Standard使用自动（自适应）时间步进算法来选择这是基于用户提供的关于时间增量中允许的最大温度变化容差，并根据此参数以及[方程2.11.1-7](02s11a43-Uncoupled-heat-transfer-analysis.md)在非线性情况下的收敛率来调整增量。
