...
同样使用 ![](../graphics/usb_eqn01165.gif) 与 *z* 无关的假设。![](../graphics/usb_eqn01198.gif) 是将干土与部分饱和土分开的表面位置。假设对于  土体是干燥的（![](../graphics/usb_eqn01199.gif)），对于 ![](../graphics/usb_eqn01200.gif)![](../graphics/usb_eqn01201.gif) 是部分饱和的，对于 ![](../graphics/usb_eqn01202.gif) 是完全饱和的。
