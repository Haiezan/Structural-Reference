...
#### Abaqus/Explicit 中活动自由度的要求

对于类型 VU*n* 的用户单元，活动自由度有以下额外要求：
...
单元在通用分析步骤中对模型的主要贡献是它提供依赖于节点变量 ![](../graphics/usb_eqn05866.gif)![](../graphics/usb_eqn05867.gif) 和单元内解相关状态变量 ![](../graphics/usb_eqn05868.gif) 的节点力 ：
...
单元对模型的主要贡献是它提供依赖于节点变量 ![](../graphics/usb_eqn00825.gif)![](../graphics/usb_eqn05867.gif)、节点变量速率 ![](../graphics/usb_eqn05903.gif) 以及单元内解相关状态变量 ![](../graphics/usb_eqn05868.gif) 的节点力 ：
