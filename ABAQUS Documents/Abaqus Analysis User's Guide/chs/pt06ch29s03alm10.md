...
要指定附加梁惯性，您可以在局部（1、2）梁横截面轴系中定义以点![](../graphics/usb_eqn04541.gif)为中心位置的质量（每单位长度）。要包含旋转惯量（每单位长度），您还可以定义横截面局部（1、2）系统中旋转惯量坐标系第一轴相对于梁横截面轴系中局部1方向的角度位置![](../graphics/usb_eqn00156.gif)（以度为单位）。[图29.3.5-1](pt06ch29s03alm10.md#usb-elm-ebeamsectionbehaviorfig0)有例证。

**图29.3.5-1** 具有附加惯性的梁单元。

![](../graphics/usb_eqn00113.gif)![](../graphics/usb-elm-ebeamsectionbehavior.png)
