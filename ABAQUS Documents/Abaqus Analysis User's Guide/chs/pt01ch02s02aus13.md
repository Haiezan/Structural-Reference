...
例如，用户定义的局部坐标系用于在壳单元中定义钢筋（![](../graphics/usb_eqn00053.gif)![](../graphics/usb_eqn00156.gif)=![](../graphics/usb_eqn00166.gif)），RBANG的输出值为75，如图2.2.3-9所示：
