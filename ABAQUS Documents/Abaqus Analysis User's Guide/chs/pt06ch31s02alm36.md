...
如图31.2.10-6](pt06ch31s02alm36.md#usb-elm-econnect-damage-combinedunload-nls)所示，除了加载曲线外，您还可以指定卸载曲线![](../graphics/usb_eqn03562.gif)，以及连接加载曲线和卸载曲线的恒定过渡斜率。当连接器加载时，力沿加载曲线给出的路径。如果连接器卸载（例如在B点），则力沿卸载曲线![](../graphics/usb_eqn03563.gif)![](../graphics/usb_eqn03559.gif)进行。路径![](../graphics/usb_eqn03564.gif)由恒定过渡斜率定义，![](../graphics/usb_eqn03565.gif)位于指定的卸载曲线上。卸载后的再加载沿卸载路径![](../graphics/usb_eqn03560.gif)进行，直到加载使得位移变得大于![](../graphics/usb_eqn05477.gif)，之后加载路径沿加载曲线进行。
