...
其中 ![](../graphics/usb_eqn00310.gif) 是静态屈服应力，![](../graphics/usb_eqn02929.gif) 是等效塑性应变，![](../graphics/usb_eqn02927.gif) 是等效塑性应变率，R是一个比值，定义为在  时的 ![](../graphics/usb_eqn02930.gif)。此方法在["率相关屈服，" 第23.2.3节](pt05ch23s02abm19.md)中有进一步描述。

| **输入文件用法：** | 使用以下两个选项： |
| --- | --- |
|  | ``` [*PLASTIC](../key/key-link.md#usb-kws-mplastic)* (指定静态屈服应力 ![](../graphics/usb_eqn02931.gif)![](../graphics/usb_eqn02932.gif))* [*RATE DEPENDENT](../key/key-link.md#usb-kws-mratedependent)* (指定比值 ![](../graphics/usb_eqn02933.gif))* ``` |
