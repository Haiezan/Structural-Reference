...
对于除C3D10MP和C3D10MPH外的所有单元，边中节点处为1、2、3（它们也在边中节点处活动自由度8）
...
膜条件适用于所有具有温度自由度的单元。如["热载荷，" 第34.4.4节](pt07ch34s04aus123.md)中所述指定。

**载荷ID (*FILM)：**  F*n***Abaqus/CAE载荷/相互作用：**  **表面膜条件****单位：**  [JL2T1![](../graphics/usb_eqn00123.gif)1](../popups/usb-int-iconventions-unitsym.md)**描述：**  面*n*上提供的膜系数和受热温度（![](../graphics/usb_eqn00123.gif)的单位）。
...
基于表面的膜条件适用于所有具有温度自由度的单元。如["热载荷，" 第34.4.4节](pt07ch34s04aus123.md)中所述指定。

**载荷ID (*SFILM)：**  F**Abaqus/CAE载荷/相互作用：**  **表面膜条件****单位：**  [JL2T1![](../graphics/usb_eqn00123.gif)1](../popups/usb-int-iconventions-unitsym.md)**描述：**  单元表面上提供的膜系数和受热温度（![](../graphics/usb_eqn00123.gif)的单位）。

**载荷ID (*SFILM)：**  FNU(S)**Abaqus/CAE载荷/相互作用：**  **表面膜条件****单位：**  [JL2T1![](../graphics/usb_eqn00123.gif)1](../popups/usb-int-iconventions-unitsym.md)**描述：**  单元表面上提供的非均匀膜系数和受热温度（![](../graphics/usb_eqn00123.gif)的单位），幅值通过用户子程序[`FILM`](../sub/sub-link.md#sub-xsl-film)提供。
