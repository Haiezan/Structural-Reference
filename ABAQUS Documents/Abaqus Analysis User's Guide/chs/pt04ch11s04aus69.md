...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互**：**表面到表面接触 (Standard)** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互**：**表面到表面接触 (Standard)**，选择主表面和从属表面 |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT** 或 **增强 VCCT**，**容差** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT**，**混合模式行为**：**BK** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT**，**混合模式行为**：**Power** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT**，**混合模式行为**：**Reeder** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT**，切换开启**指定不稳定裂纹扩展容差**：*指定值* |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**增强 VCCT** |
| --- | --- |
...
当您使用临界应力、临界裂纹张开位移或裂纹长度与时间断裂准则时，您可以定义在该节点开始脱粘后，如何将此力随时间减到零。您指定相对振幅 *a* 作为节点开始脱粘后时间的函数。因此，假设当节点 *N* 开始脱粘时（发生在时间 ），表面之间在从属节点 *N* 传递的力为 ![](../graphics/usb_eqn01903.gif)。那么，对于任何时间 ![](../graphics/usb_eqn01904.gif)![](../graphics/usb_eqn01905.gif)，节点 *N* 处表面之间传递的力为 ![](../graphics/usb_eqn01906.gif)。相对振幅在相对时间 0.0 必须为 1.0，在给出的最后一个相对时间点必须降至 0.0。
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****：**名称：** *crack name*，**类型**：**使用 VCCT 脱粘**，选择步骤和表面到表面 (Standard) 交互，**脱粘力**：**Step** 或 **Ramp** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：**创建交互属性**：**接触**，****Mechanical**![](../graphics/images/arrow.gif)**Fracture Criterion****，**类型**：**VCCT** 或 **增强 VCCT**，**粘性** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：****Other**![](../graphics/images/arrow.gif)**General Solution Controls**![](../graphics/images/arrow.gif)**Edit****：*step name*，**VCCT 线性缩放** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****：**类型**：**使用 VCCT 脱粘**，**每** *n* **增量写入输出到 DAT 文件** |
| --- | --- |
