...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: **Name:** *crack name*, **Type:** **Contour integral** 或 **XFEM**分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type:** *integral_type* |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: J-integral** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Step for residual stress initialization values:** *step*, **Type: J-integral** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: Ct-integral** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Step for residual stress initialization values:** *step*, **Type: Ct-integral** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: Stress intensity factors** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Step for residual stress initialization values:** *step*, **Type: Stress intensity factors** |
| --- | --- |
...
其中裂纹扩展角 ![](../graphics/usb_eqn01835.gif) 是相对于裂纹平面测量的，![](../graphics/usb_eqn01836.gif) 表示"直向前"方向中的裂纹扩展。如果  则 ![](../graphics/usb_eqn01837.gif)，而如果 ![](../graphics/usb_eqn01838.gif) 则 ![](../graphics/usb_eqn01839.gif)。裂纹扩展角从 ![](../graphics/usb_eqn01840.gif)![](../graphics/usb_eqn00854.gif) 到 ![](../graphics/usb_eqn01806.gif) 测量；即，它是从  在图 11.4.2-1 中围绕方向 ![](../graphics/usb_eqn01841.gif) 或从 ![](../graphics/usb_eqn00854.gif) 逆时针测量。
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: Stress intensity factors**, **Crack initiation criterion: Maximum tangential stress** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: Stress intensity factors**, **Crack initiation criterion: Maximum energy release rate** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: Stress intensity factors**, **Crack initiation criterion: K11=0** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Type: T-stress** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Step for residual stress initialization values:** *step*, **Type: T-stress** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘 |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘，然后选择裂纹尖端（二维）或裂纹线（三维） |
| --- | --- |
...
虚拟裂纹扩展方向可以通过指定裂纹平面的法线 ![](../graphics/usb_eqn01806.gif) 来定义。在这种情况下，Abaqus/Standard 将计算一个与裂纹前缘切线 ![](../graphics/usb_eqn00854.gif)![](../graphics/usb_eqn01682.gif) 和法线 ![](../graphics/usb_eqn01806.gif) 正交的虚拟裂纹扩展方向 。如图 11.4.2-1 所示，对于三维裂纹，![](../graphics/usb_eqn01842.gif)；对于二维裂纹，我们有 ![](../graphics/usb_eqn01843.gif) 和 ![](../graphics/usb_eqn01844.gif)。指定法线意味着裂纹平面是平的，因为每个轮廓积分只能给出一个 ![](../graphics/usb_eqn01806.gif) 值。
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘：**Specify crack extension direction using: Normal to crack plane** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘：**Specify crack extension direction using: q vectors** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹尖端或裂纹线，并指定裂纹扩展方向：**General**: 切换开启 **On symmetry plane (half-crack model)** |
| --- | --- |
...
其中 ![](../graphics/usb_eqn01854.gif) 是等效总应变，![](../graphics/usb_eqn01855.gif) 是参考应变，![](../graphics/usb_eqn01856.gif) 是 Mises 应力，![](../graphics/usb_eqn01857.gif) 是初始屈服应力，*n* 是幂律硬化指数（通常在 3 到 8 范围内；对于大 ，![](../graphics/usb_eqn01858.gif) 非常接近理想塑性），![](../graphics/usb_eqn00856.gif)![](../graphics/usb_eqn00156.gif) 是材料常数（通常在 0.5 到 1.0 范围内）。
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹尖端，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.25, **Collapsed element side, single node** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹尖端，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.5, **Collapsed element side, duplicate nodes** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹尖端，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.25, **Collapsed element side, duplicate nodes** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹线，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.25, **Collapsed element side, single node** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹线，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.5, **Collapsed element side, duplicate nodes** |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 相互作用模块：****Special**![](../graphics/images/arrow.gif)**Crack**![](../graphics/images/arrow.gif)**Create****: 选择裂纹前缘和裂纹线，并指定裂纹扩展方向：**Singularity**: **Midside node parameter:** 0.25, **Collapsed element side, duplicate nodes** |
| --- | --- |
...
钢筋的贡献仅在壳单元的 *J* 积分和 ![](../graphics/usb_eqn00854.gif)![](../graphics/usb_eqn01329.gif) 积分计算中包括，这些壳单元使用在分析期间集成的壳截面定义（参见 ["使用在分析期间集成的壳截面来定义截面行为," 第 29.6.5 节"](pt06ch29s06alm19.md)）。
...
| **Abaqus/CAE 用法：** | 分析步模块：历史输出请求编辑器：**Domain: Crack**: *crack name*, **Number of contours:** *n*, **Save output at** |
| --- | --- |
