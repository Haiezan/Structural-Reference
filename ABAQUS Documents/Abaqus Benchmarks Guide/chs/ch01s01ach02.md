...
图1.1.2-3（[图1.1.2-3](ch01s01ach02.md#sxmaniso-tsaihillstress)）显示了Tsai-Hill理论的失效表面（即，对于给定的![](../graphics/bmk_eqn00011.gif)![](../graphics/bmk_eqn00012.gif)，屈服失效指数![](../graphics/bmk_eqn00013.gif)1.0的应力值），以及板中心每个截面点的应力状态。只有截面点6的应力状态在失效表面之外（![](../graphics/bmk_eqn00014.gif)1.0）。
