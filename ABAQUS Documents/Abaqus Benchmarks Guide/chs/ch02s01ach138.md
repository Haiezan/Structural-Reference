...
[图2.1.1-2](ch02s01ach138.md#sxmtorsion-shearstress)显示了CGAX8单元模型（其中 = S13）的剪应力，![](../graphics/bmk_eqn01276.gif)，随空心圆柱半径的变化，并与解析解进行比较。所有单元的结果都与解析解吻合良好。子结构分析的结果与不使用子结构时获得的结果一致。
...
![](../graphics/bmk_eqn01277.gif)![](../graphics/sxmtorsion-hollowcyl-nls.png)
