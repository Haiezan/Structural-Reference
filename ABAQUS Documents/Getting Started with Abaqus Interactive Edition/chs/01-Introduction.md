...
![](../graphics/gss-lug-partb-c.png)![](../graphics/cnv-mouse-nls.png)
...
![](../graphics/gss-discretized-nls.png)![图1-6 每个节点的自由体图](../graphics/gss-free-body-nls.png)

**图1-6** 每个节点的自由体图

假设杆的长度变化很小，则单元1中的应变由下式给出：

![](../graphics/gsa_eqn00017.gif)![](../graphics/gsa_eqn00017.gif)![](../graphics/gsx-inc2-rod-config.png)![](../graphics/gsx-inc3-rod-config.png)
