...
用于评估率相关数据。 ![](../graphics/usb_eqn05157.gif) 是时间增量 ![](../graphics/usb_eqn00456.gif)] 中等效塑性运动的增量变化，![](../graphics/usb_eqn05158.gif) 和 ![](../graphics/usb_eqn05159.gif) 分别是增量开始和结束时的塑性运动率。 因子 ![](../graphics/usb_eqn00348.gif) (![](../graphics/usb_eqn02195.gif)) 有助于过滤与率相关连接行为相关的高频振荡。 您可以直接指定率滤波因子的值 ![](../graphics/usb_eqn00348.gif)![](../graphics/usb_eqn02196.gif), RATE FILTER FACTOR=![](../graphics/usb_eqn00348.gif) ``` ``` [*CONNECTOR DAMAGE INITIATION](../key/key-link.md#usb-kws-mconnectordamageinit), RATE FILTER FACTOR=![](../graphics/usb_eqn00348.gif) ``` |
