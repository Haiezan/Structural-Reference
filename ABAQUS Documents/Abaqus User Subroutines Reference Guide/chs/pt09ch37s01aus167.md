...
在Abaqus/Explicit中，您可以指定以与接触刚度相关的临界阻尼分数形式的无量纲阻尼系数；此方法在Abaqus/Standard中不可用。阻尼力将用![](../graphics/usb_eqn06204.gif)计算，其中*m*是节点质量，![](../graphics/usb_eqn06205.gif)是节点接触刚度（单位为![](../graphics/usb_eqn06206.gif)），![](../graphics/usb_eqn06202.gif)是两个表面之间的相对运动速率。
