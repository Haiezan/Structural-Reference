...
弹性体的非线性率相关性通过将力学响应分解为对应力松弛测试中接近的状态的平衡网络（A）和捕获偏离平衡状态的非线性率相关偏差的随时间变化的网络（B）来建模。总应力假定为两个网络中应力的和。变形梯度![](../graphics/usb_eqn00073.gif)假定作用于两个网络，并根据乘积分解![](../graphics/usb_eqn02834.gif)在网络B中分解为弹性和非弹性部分。非线性率相关材料模型能够再现承受重复循环加载的弹性体的滞后行为。它不模拟"Mullins效应"——弹性体首次承受载荷时的初始软化。

材料模型由以下完全定义：
- 表征模型弹性响应的超弹性材料模型；
- 应力缩放因子*S*，定义在瞬时加载下网络B携带的应力与网络A携带的应力之比；即两个网络中相同的弹性拉伸；
- 正指数*m*，通常大于1，表征网络B中有效蠕变应变率的有效应力依赖性；
- 指数*C*，限制在![](../graphics/usb_eqn02835.gif)中，表征网络B中有效蠕变应变率对有效蠕变应变的依赖性；
...
其中![](../graphics/usb_eqn02837.gif)是网络B中的有效蠕变应变率，![](../graphics/usb_eqn02838.gif)是网络B中的标称蠕变应变，![](../graphics/usb_eqn02839.gif)是网络B中的有效应力。网络B中的链拉伸![](../graphics/usb_eqn02840.gif)定义为

![](../graphics/usb_eqn02841.gif)

其中![](../graphics/usb_eqn02842.gif)。网络B中的有效应力定义为![](../graphics/usb_eqn02843.gif)，其中![](../graphics/usb_eqn02844.gif)是偏量Cauchy应力张量。
