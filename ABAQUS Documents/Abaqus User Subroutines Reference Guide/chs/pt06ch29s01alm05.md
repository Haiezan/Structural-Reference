...
| **Abaqus/CAE用法：** | 属性模块：**创建截面**：选择**膜**作为截面**类别**，选择**复合**作为截面**类型**：**层数：***number of layers********分配**![](../graphics/usb_eqn04498.gif)![](../graphics/usb_eqn04498.gif)![](../graphics/images/arrow.gif)![](../graphics/images/arrow.gif)**截面****：选择区域 |
| --- | --- |
