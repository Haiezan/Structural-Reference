...
| **Abaqus/CAE 用法：** | 所有模块：**Model****Edit attributes****model name****：Physical Constants**：切换打开 **Universal gas constant**：![](../graphics/images/arrow.gif)![](../graphics/images/arrow.gif)![](../graphics/usb_eqn01936.gif) |
| --- | --- |
...
| **Abaqus/CAE 用法：** | 所有模块：**Model****Edit attributes****model name****：Physical Constants**：切换打开 **Absolute zero temperature**：![](../graphics/images/arrow.gif)![](../graphics/images/arrow.gif)![](../graphics/usb_eqn00807.gif) |
| --- | --- |
