...
解析刚性表面的外表面法向由形成表面轮廓的线段方向决定。线段序列定义了一个矢量![](../graphics/usb_eqn00233.gif)，沿刚性表面从第一段的起点到最后一段的终点。外表面法向通过取矢量![](../graphics/usb_eqn00234.gif)（表面所定义平面的单位法向）与矢量![](../graphics/usb_eqn00233.gif)（表面的切线）的叉积创建：![](../graphics/usb_eqn00235.gif)。图2.3.4-5显示了解析刚性表面定义平面中的矢量![](../graphics/usb_eqn00233.gif)![](../graphics/arigsurf-2d-normals-nls.png)
