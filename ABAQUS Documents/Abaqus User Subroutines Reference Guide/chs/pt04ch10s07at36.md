...
| --- | --- |
|  | 属性模块：材料编辑器：****Other**![](../graphics/images/arrow.gif)**Pore Fluid**![](../graphics/images/arrow.gif)**Gap Flow****: Type: **Newtonian**：切换**Maximum Permeability** 并输入 ![](../graphics/usb_eqn01734.gif) 的值 使用以下选项为幂律流体定义切向流动：属性模块：材料编辑器：****Other**![](../graphics/usb_eqn01734.gif)**Gap Flow****: Type: **Power law** Abaqus/CAE 中不支持初始间隙开口。 |
