...
这里，![](../graphics/usb_eqn01696.gif) 表示最大允许主应力。符号 ![](../graphics/usb_eqn01697.gif) 表示 Macaulay 括号，具有通常的解释（即如果  则 ![](../graphics/usb_eqn01698.gif)，如果 ![](../graphics/usb_eqn01699.gif) 则 ![](../graphics/usb_eqn01700.gif)）。Macaulay 括号用于表示纯压缩应力状态不会萌生损伤。假定当最大主应力比（如上定义）达到 1 时损伤开始萌生。
...
![](../graphics/usb_eqn01701.gif)![](../graphics/usb_eqn01702.gif)
...
| --- | --- |
|  | 属性模块：材料编辑器：****Other**![](../graphics/images/arrow.gif)**Pore Fluid**![](../graphics/images/arrow.gif)**Gap Flow****: Type: **Newtonian**：切换**Maximum Permeability** 并输入 ![](../graphics/usb_eqn01734.gif) 的值 使用以下选项为幂律流体定义切向流动：属性模块：材料编辑器：****Other**![](../graphics/images/arrow.gif)![](../graphics/images/arrow.gif)**Gap Flow****: Type: **Power law** Abaqus/CAE 中不支持初始间隙开口。 |
...
| **输入文件用法：** | 使用以下选项之一 |
| --- | --- |
|  | ``` [*FRACTURE CRITERION](../key/key-link.md#usb-kws-hfracturecriterion), TYPE=VCCT, VISCOSITY=![](../graphics/usb_eqn01769.gif)![](../graphics/usb_eqn01770.gif) ``` ``` [*FRACTURE CRITERION](../key/key-link.md#usb-kws-hfracturecriterion), TYPE=ENHANCED VCCT, VISCOSITY=![](../graphics/usb_eqn01770.gif) ``` |
