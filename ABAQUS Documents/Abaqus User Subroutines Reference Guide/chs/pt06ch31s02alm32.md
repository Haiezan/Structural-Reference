...
其中 ![](../graphics/usb_eqn00846.gif) 是最终有助于屈服函数的相对运动可用分量中的力和力矩集合；连接势能 ![](../graphics/usb_eqn05348.gif) 定义了连接牵引力的大小，类似于在 Mises 塑性中定义等效应力状态，由 Abaqus 自动定义或用户定义；并且 ![](../graphics/usb_eqn04624.gif) 是屈服力/力矩。只要 ，连接相对运动 ![](../graphics/usb_eqn05197.gif) 保持弹性；当发生塑性流动时，![](../graphics/usb_eqn05349.gif)![](../graphics/usb_eqn05350.gif)。
...
其中 ![](../graphics/usb_eqn05360.gif) 是为塑性势能指定的第一个分量中的力/力矩，![](../graphics/usb_eqn05361.gif) 是为同一势能指定的第二个分量中的力/力矩。如果 ，则 ![](../graphics/usb_eqn05362.gif)；如果 ![](../graphics/usb_eqn05363.gif)，则 ![](../graphics/usb_eqn05364.gif)；如果两者都不为 0.0，则 ![](../graphics/usb_eqn05365.gif)![](../graphics/usb_eqn05366.gif) 在 1.0 和 1.0 之间的某个位置。
