...
您可以将三种类型的低通无限脉冲响应滤波器定义为模型定义的一部分。[图4.1.3-5](pt02ch04s01aus40.md#filter-magnitude-curves)展示了模拟类型滤波器的典型幅值曲线，其中![](../graphics/oprintfile-distload-nls.png)![](../graphics/usb_eqn00286.gif)表示归一化截止频率，即截止频率与采样频率（采样频率是时间增量的倒数）的比值。
