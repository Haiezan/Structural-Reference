...
### *SHEAR CENTER定义梁截面剪切中心的位置。

此选项只能与[*BEAM GENERAL SECTION](ch02abk05.md)，SECTION=GENERAL或[*BEAM GENERAL SECTION](ch02abk05.md)，SECTION=MESHED选项配合使用。它用于定义截面剪切中心相对于局部(1, 2)轴系的位置。
